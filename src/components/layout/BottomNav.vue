<template>
  <nav class="md:hidden fixed bottom-0 left-0 w-full bg-white border-t border-slate-200 px-6 py-3 flex justify-between items-center z-50 pb-safe">
    
    <RouterLink to="/" class="flex flex-col items-center gap-1 text-slate-400" active-class="text-indigo-600">
    ...
    <RouterLink to="/patterns" class="flex flex-col items-center gap-1 text-slate-400" active-class="text-indigo-600">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-6 h-6">
        <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z" />
      </svg>
      <span class="text-[10px] font-bold">Patterns</span>
    </RouterLink>

    <RouterLink to="/tutor" class="flex flex-col items-center gap-1 text-slate-400" active-class="text-indigo-600">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-6 h-6">
      ...
      <span class="text-[10px] font-bold">AI Tutor</span>
    </RouterLink>

    <RouterLink to="/progress" class="flex flex-col items-center gap-1 text-slate-400" active-class="text-indigo-600">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-6 h-6">
