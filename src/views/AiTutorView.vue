<template>
  <div class="flex flex-col min-h-full">
    ...
    >
      <div class="flex items-center gap-5 min-w-0">
        ...
        <div class="flex items-center gap-3 min-w-0">
          <div
            class="w-9 h-9 rounded-xl bg-blue-700 flex items-center justify-center shrink-0"
            aria-hidden="true"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="flex items-center gap-3 shrink-0 ml-4">
        <div
          class="flex items-center bg-slate-100 rounded-full p-1 text-xs font-semibold"
          role="radiogroup"
          aria-label="AI model"
        >
          <button
    ...
    <div class="flex-grow overflow-hidden p-6">
      <div
        class="bg-white rounded-2xl border border-slate-200 shadow-sm h-full flex flex-col overflow-hidden"
      >
        <!-- Messages (scrollable) -->
        <div
          ref="messagesEl"
        ...
        >
          ...
          <div v-if="isTyping" class="flex gap-3 items-start" aria-label="AI is typing">
            <div
              class="w-9 h-9 rounded-full bg-blue-700 flex items-center justify-center text-white text-xs font-black shrink-0"
              aria-hidden="true"
            >
              AI
            </div>
